...
# Comparar contra auto_exportaciones_oc (Bloque 4.3, Office des Changes) una
# vez corrido - son dos fuentes distintas (mirror stats WITS vs. balanza
...
#===============================================================================#
# BLOQUE 3: DOTACIÓN FACTORIAL (3b) — Penn World Tables + IED por origen
#===============================================================================#
...
## --- 3.4 Stock de IED entrante, total y por país de origen (UNCTADstat / Office des Changes) ---
...
#===============================================================================#
# BLOQUE 4: DATOS DUROS (rondas 1 y 2 de Spark)
#===============================================================================#
# Ver TP2_fuentes_de_datos.md y TP2_seguimiento_investigacion_ronda2.md.
...
## --- 4.1 OCP (fosfatos): financieros y empleo ---
...
## --- 4.2 USGS: reservas y producción física de roca fosfórica ---
...
## --- 4.3 Automotor: producción física, empleo y exportaciones ---
...
## --- 4.4 Inversión / IED en el sector automotor (puntual, no serie anual limpia) ---
...
## --- 4.5 HCP: valor agregado y coeficientes insumo-producto ---
...
# No hay matriz insumo-producto desagregada disponible (Ley 371-71 de
...
# 20 ramas agregadas). Estos coeficientes SÍ alcanzan para calibrar un
# Cobb-Douglas simple (ver Bloque 5) - no hace falta insistir en pedir la
# matriz completa.
...
## --- 4.7 Caisse de Compensation / régimen AMDIE (Bloque 4 de la presentación) ---
...
#===============================================================================#
# BLOQUE 5: CALIBRACIÓN EMPÍRICA DEL MFE (Cobb-Douglas con income shares)
#===============================================================================#
...
calcular_vpmgl_cobb_douglas <- function(produccion, empleo, alpha) {
  ...
  base |>
    mutate(
      ...
      # o ocp_financieros/auto_exportaciones_oc como proxy de precio
...
#===============================================================================#
# BLOQUE 6: LO QUE QUEDA GENUINAMENTE SIN RESOLVER (no insistir con Spark)
#===============================================================================#
...
#    y alcanzan para la calibración del Bloque 5.
